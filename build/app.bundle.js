...
var _ui = __webpack_require__(356);
...
function deletePost(e) {
  ...
  if (a.classList.contains('delete') && _ui2.default.state !== 'edit') {
    _axios2.default.delete(postUrl + '/' + a.dataset.id).then(function () {
...
function submitPost(e) {
  ...
  if (!id) {
    return _axios2.default.post(postUrl, data).then(function () {
      getPosts();
  ...
  return _axios2.default.put(postUrl + '/' + id, data).then(function () {
    getPosts();
