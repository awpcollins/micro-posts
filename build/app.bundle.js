...
$export($export.P + $export.F * (__webpack_require__(48) != Object || !__webpack_require__(23)(arrayJoin)), 'Array', {
...
var postUrl = 'https://posts-59834.firebaseio.com/posts';

document.addEventListener('DOMContentLoaded', getPosts);
_ui2.default.postSubmit.addEventListener('click', submitPost);
_ui2.default.posts.addEventListener('click', deletePost);
_ui2.default.posts.addEventListener('click', editPostState);
document.querySelector('.card-form').addEventListener('click', createPostState);

function getPosts() {
  _axios2.default.get(postUrl + '.json').then(function (res) {
    return _ui2.default.showPosts(res.data);
  }).catch(function (err) {
...
function createPostState(e) {
  ...
  if (e.target.classList.contains('post-cancel')) {
    _ui2.default.changeFormState('create');
  }
}
...
function editPostState(e) {
  ...
  if (a.classList.contains('edit') && _ui2.default.state !== 'edit') {
    var id = a.dataset.id;

    var title = a.previousElementSibling.previousElementSibling.textContent;
    var body = a.previousElementSibling.textContent;
    var data = { id: id, title: title, body: body };

    _ui2.default.fillForm(data);
  }
}
...
function deletePost(e) {
  ...
  if (a.classList.contains('delete') && _ui2.default.state !== 'edit') {
    _axios2.default.delete(postUrl + '/' + a.dataset.id + '.json').then(function () {
      a.parentElement.parentElement.remove();
      _ui2.default.showAlert('Post removal successful', 'alert alert-success');
    }).catch(function () {
      _ui2.default.showAlert('Post removal failed', 'alert alert-danger');
    });
  }
}
...
function submitPost(e) {
  ...
  var title = _ui2.default.titleInput.value;
  var body = _ui2.default.bodyInput.value;

  if (body === '' || title === '') {
    return _ui2.default.showAlert('Please make sure all fields are completed', 'alert alert-danger');
  }

  var id = _ui2.default.idInput.value;
  var data = {
    title: title,
    body: body
  };
  ...
  if (!id) {
    return _axios2.default.post(postUrl + '.json', data).then(function () {
      getPosts();
      _ui2.default.showAlert('Post added', 'alert alert-success');
      _ui2.default.clearFields();
    }).catch(function (err) {
      return console.log(err);
    });
  }

  return _axios2.default.put(postUrl + '/' + id + '.json', data).then(function () {
    getPosts();
    _ui2.default.showAlert('Post edited', 'alert alert-success');
    _ui2.default.clearFields();
  });
}
  ...
  _createClass(UI, [{
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        this.state = 'create';
        var _cancelBtn = document.querySelector('.post-cancel');
    ...
    value: function showAlert(message, className) {
      ...
      setTimeout(function () {
        _this.constructor.clearAlert(className);
      }, 3000);
    }
  }, {
    key: 'clearFields',
